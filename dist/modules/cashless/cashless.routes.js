...
router.get('/payment-methods', auth_middleware_1.authenticate, cashless_controller_1.getPaymentMethods);
router.post('/payment-methods', auth_middleware_1.authenticate, cashless_controller_1.addPaymentMethod);
router.delete('/payment-methods/:id', auth_middleware_1.authenticate, cashless_controller_1.deletePaymentMethod);
